    ...
    if request.method == 'GET':
        try:
            fun_facts = [
                ...
                {
                    "name": "Fun Fact #2",
                    "description": "I hike in the summer, typically early morning to see the beautiful views."
                },
                {
                    "name": "Fun Fact #3",
                    "description": "I work out regularly, running a Push Pull Legs (PPL) split."
                },
                {
                    "name": "Fun Fact #4",
                    "description": "I used to DJ during my undergraduate college years."
                },
                {
                    "name": "Fun Fact #5",
                    "description": (
                        "I like to play video games, and the game I have played the most is League of Legends."
                    )
                },
            ]
